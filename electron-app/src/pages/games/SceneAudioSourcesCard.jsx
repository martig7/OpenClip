  ...
  return (
    <>
      <div className="card" style={{ marginTop: 16 }}>
                ...
                {loadingAudioInputs ? (
                  ...
                  <div style={{ padding: '10px 14px' }}>
                    ...
                    <div style={{ fontSize: 11, color: 'var(--text-muted)' }}>
                      Make sure OBS is running and WebSocket is configured.
                    </div>
                  </div>
                        ...
                        {availableAudioInputs
                          ...
                          .map((entry, i) => {
                            ...
                            return (
                              ...
                              >
                                {entry.kind === 'wasapi_input_capture' ? (
                                  <Mic size={14} />
                                ) : (
                                  <Music size={14} />
                                )}
        ...
        >
          Audio sources added here are applied to all game scenes. Use the Edit button on a game to
          manage per-scene sources.
        </div>
        ...
        {masterAudioSources.length === 0 ? (
          ...
          >
            ...
            >
              Click <strong>Add Source</strong> to pick from OBS inputs or Windows audio devices.
            </div>
          </div>
        ) : (
          <>
        ...
        {masterAudioSources.length > 0 && (
          <div style={{ padding: '8px 16px', fontSize: 11, color: 'var(--text-muted)' }}>
            OBS must be running with WebSocket enabled. Removing from this list does not remove from
            existing scenes.
          </div>
        )}
      </div>
