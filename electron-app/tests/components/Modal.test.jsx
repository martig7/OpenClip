...
describe('Modal', () => {
  ...
  it('calls onCancel when backdrop is clicked', () => {
    ...
    render(<Modal isOpen title="T" message="m" onConfirm={vi.fn()} onCancel={onCancel} />)
  ...
  it('calls onConfirm when confirm button is clicked', () => {
    ...
    render(<Modal isOpen title="T" message="m" onConfirm={onConfirm} onCancel={vi.fn()} />)
  ...
  it('applies btn-danger class when danger prop is true', () => {
    render(<Modal isOpen title="T" message="m" onConfirm={vi.fn()} onCancel={vi.fn()} danger />)
