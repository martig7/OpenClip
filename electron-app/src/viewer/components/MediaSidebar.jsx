  ...
  const filteredItems = useMemo(() => {
    ...
    result = [...result].sort((a, b) => {
      switch (sortBy) {
        ...
        case 'game': return dir * a.game_name.localeCompare(b.game_name) || (b.mtime - a.mtime)
        default:     return dir * (a.mtime - b.mtime)
      }
    })
      ...
      <div className="msb-header">
        ...
        <div className="msb-row1">
          ...
          <div className="msb-search">
            <span className="msb-search-icon"><Search size={11} /></span>
            <input
              type="search"
              placeholder="Search..."
              value={searchQuery}
