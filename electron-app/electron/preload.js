...
contextBridge.exposeInMainWorld('api', {
  ...
  addAudioSourceToScenes: (sceneNames, inputKind, inputName, inputSettings) => ipcRenderer.invoke('obs:ws:add-audio-source', sceneNames, inputKind, inputName, inputSettings),
