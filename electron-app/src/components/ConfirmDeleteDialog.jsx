      ...
      <div className="modal" onClick={(e) => e.stopPropagation()} style={{ maxWidth: 400 }}>
        ...
        {confirmDeleteGame.game.scene && (
          ...
          >
            ...
            />
            <span>
              This game has an OBS scene: <strong>{confirmDeleteGame.game.scene}</strong>. Do you
              also want to delete it from OBS?
            </span>
          </div>
        )}
        <div style={{ display: 'flex', gap: 8, justifyContent: 'flex-end', marginTop: 16 }}>
          ...
          {confirmDeleteGame.game.scene && (
            <button className="btn btn-secondary" onClick={() => onConfirm(false)}>
              Game only
            </button>
          )}
          <button
